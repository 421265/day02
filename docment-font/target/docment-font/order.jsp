...
<head>
    ...
    <link rel="stylesheet" href="/style/css/shop_manager.css" type="text/css" />
...
<div class="shop_member_bd clearfix">
    ...
    <div class="shop_member_bd_left clearfix">
        ...
        <div class="shop_member_bd_left_pic">
            <a href="javascript:void(0);"><img src="/style/images/avatar.png" /></a>
        </div>
        <div class="clear"></div>
    ...
    <script>
        ...
        //                     "                            <tbody>\n" +
        //                     "                            <tr>\n" +
        //                     "                                <td class=\"dingdan_pic\"><img src=\""+box.turl+"\" /></td>\n" +
        //                     "                                <td class=\"dingdan_title\"><span><a href=\"\">"+box.name+"</a></span><br />鞋码:37 颜色:黑色 </td>\n" +
        //                     "                                <td class=\"dingdan_danjia\">￥<strong>"+box.money+"</strong></td>\n" +
        //                     "                                <td class=\"dingdan_shuliang\">"+box.numor+"</td>\n" +
        //                     "                                <td class=\"dingdan_zongjia\">￥<strong>"+zong+"</strong><br />(免运费)</td>\n" +
