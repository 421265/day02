...
<head>
    ...
    <link rel="stylesheet" href="/style/css/shop_home.css" type="text/css" />
    <script type="text/javascript" src="/style/js/jquery.js" ></script>
    <script type="text/javascript" src="/style/js/topNav.js" ></script>
    <script type="text/javascript" src="/style/js/focus.js" ></script>
    <script type="text/javascript" src="/style/js/shop_home_tab.js" ></script>
    <script>
        $(function (){
            $.ajax({
                url:'/user/getuser',
                ...
                success:function(e){
                    ...
                    if(e){
                        for(var i=0;i<e.length;i++){
                            ...
                            $("#spc_li1").append(`
                            <li><dl>
                                <dt><a href="/goods?id=\${e[i].spid}"><img src="\${imu}"/></a></dt>
                             <dd><a href="/goods?id=\${e[i].spid}">\${e[i].titlename}</a></dd>
                             <dd>商城价：<em>\${e[i].money}</em>元</dd></dl></li>`)
                        }
                    }
                    console.log(e);
                }
    ...
    <div class="shop_hd_topNav">
        <div class="shop_hd_topNav_all">
            ...
            <div class="shop_hd_topNav_all_left">
                <p class="yonghu">您好，欢迎来到<b><a href="/">ShopCZ商城</a></b><span id="usermsg">[<a href="/login">登录</a>][<a href="/register">注册</a>]</span></p>
            ...
            <div class="shop_hd_topNav_all_right">
                <ul class="topNav_quick_menu">
                    ...
                    <li>
                        <div class="topNav_menu">
                            <a href="" class="topNavHover goods_sub_gou">购物车<b id="numbergw">0</b>种商品<i></i></a>
                            <div class="topNav_menu_bd" style="display:none;">
                                <!--
                                <ul>
                                  <li><a title="已售出的商品" target="_top" href="#">已售出的商品</a></li>
...
<div class="shop_bd clearfix">
    ...
    <div class="shop_bd_top clearfix">
        ...
        <div class="shop_bd_top_center">
            ...
            <div class="xifan_sub_box">
                ...
                <div id="xifan_bd1lfimg">
                    <div>
                        <dl class=""></dl>
                        <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/style/images/e2dfe57add8fff66ed0964b1effd39b9.jpg" alt="2011城市主题公园亲子游"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">2011城市主题公园亲子游</a></h2></dd>
                        </dl>
                        <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/style/images/e50b5d398e3b890f08e14defbc71a94d.jpg" alt="潜入城市周边清幽之地"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">潜入城市周边清幽之地</a></h2></dd>
                        </dl>
                        <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/style/images/196b173f15685a2019ab3396cd1851a4.jpg" alt="盘点中国最美雪山"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">盘点中国最美雪山</a></h2></dd>
                        </dl>
                        <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/style/images/e81345cbc3d8a7e11f9a0e09df68221d.jpg" alt="2011西安世园会攻略"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">2011西安世园会攻略</a></h2></dd>
                        </dl>
                        <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/style/images/65662b58848da87812ba371c7ff6c1ad.jpg" alt="五月乐享懒人天堂塞班岛"></a></dt>
            ...
            <!-- 图片切换  end -->
            <div class="clear"></div>
            <div class="shop_bd_top_center_hot"><img src="/style/images/index.guanggao.png" /></div>
        </div>

        <!-- 右侧 -->
        <div class="shop_bd_top_right clearfix">
            <div class="shop_bd_top_right_quickLink">
                <a href="/login" class="login" title="会员登录"><i></i>会员登录</a>
                <a href="/register" class="register" title="免费注册"><i></i>免费注册</a>
    ...
    <div class="shop_bd_2 clearfix">
            ...
            <div class="tuijian_content">
                <div id="tuijian_content_1" class="tuijian_shangpin" style="display: block;">
                    <ul>
                        <li>
                            <dl>
                                <dt><a href=""><img src="/style/images/365_7d5e08127b8d6799209674ecffbfc624.jpg_small.jpg" /></a></dt>
        ...
        <!-- 首发 -->
        <div class="shop_bd_shoufa"><img src="/style/images/shoufa.jpg" /></div>
        <!-- 首发 End -->
    ...
    <div class="shop_bd_home_block clearfix">
        ...
        <div class="shop_bd_home_block_left">
            ...
            <div class="shop_bd_home_block_left_pic">
                <a href=""><img src="/style/images/web-1-13_53bfbfc958cb55a435545033bd075bf3.png"/></a>
            </div>
        </div>
        <!-- 左边 End -->
                    ...
                    <%--success:function(e){--%>
                        <%--$.each(e,function (index,box) {--%>
                            <%--var cc = " <li>\n" +--%>
                                ...
                                <%--"                            <dd><a href=\"/goods?"+box.url+"\">"+box.name+"</a></dd>\n" +--%>
                                <%--"                            <dd>商城价：<em>"+box.money+"</em>元</dd>\n" +--%>
                                <%--"                        </dl>\n" +--%>
                                <%--"                    </li>"--%>
                            <%--$("#sp1").append(cc)--%>
                        <%--})--%>
        ...
        <div class="shop_bd_home_block_right">
            ...
            <ol class="saletop-list">
                <li class="top clearfix">
                    <dl>
                        ...
                        <dd class="nokey">1</dd>
                        <dd class="goods-pic">
                            <a href=""><span class="thumb size60"><img src="/style/images/3f81874d594894d19150843c42fb1f8e.jpg_small.jpg" /></span></a>
                        </dd>
            ...
            <div class="saletop-list_adv_pic"><a href=""><img src="/style/images/web-3-38_ff9bd2d724f7138cec1b1937000f4feb.jpg" /></a></div>
        </div>
        <!-- 右边商品排行 -->
        ...
        <div class="shop_bd_home_block_bottom">
            <ul class="">
                <li><a href=""><img src="/style/images/354b80528d2fbeefbab33c563532517e.gif" /></a></li>
                <li><a href=""><img src="/style/images/1d2dfbead590510046a6522551db8139.gif" /></a></li>
                <li><a href=""><img src="/style/images/26247430b09daa1b441b46008bfb6e6e.gif" /></a></li>
                <li><a href=""><img src="/style/images/a0ac8c6d2d3dc1470d5876923182a8e2.gif" /></a></li>
                <li><a href=""><img src="/style/images/9c5dee77a6ecdafd9e152fed8c6a4e90.gif" /></a></li>
                <li><a href=""><img src="/style/images/b175883eba95e793affb1b1ebbbf85a5.gif" /></a></li>
                <li><a href=""><img src="/style/images/6e61a1c953e5bc8c5f1ffdac36862245.gif" /></a></li>
                <li><a href=""><img src="/style/images/209abd835cd2ce2208f2dc42ba10efb4.gif" /></a></li>
            </ul>
        </div>
        <!-- 品牌展示 End -->
        ...
        <div class="shop_bd_home_block_center">
            ...
            <div class="tabs-panel">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="/style/images/04fb225ea46bd1346f330400eedb7ef2.jpg_small.jpg" /></a></dt>
