...
<head>
    ...
    <link rel="stylesheet" href="/style/css/shop_goods.css" type="text/css" />
    <script type="text/javascript" src="/style/js/jquery.js" ></script>
    <script type="text/javascript" src="/style/js/topNav.js" ></script>
    <script type="text/javascript" src="/style/js/shop_goods.js" ></script>
    <script type="text/javascript" src="/style/js/jquery.js"></script>
    <link rel="stylesheet" href="/style/css/shop_goodPic.css" type="text/css" />
    <script>
        $(function (){
            $.ajax({
                url:'/user/getuser',
...
<div class="shop_goods_bd clear">
    ...
    <div class="shop_goods_show">
        <div class="shop_goods_show_left">
            <!-- 京东商品展示 -->
            <link rel="stylesheet" href="/style/css/shop_goodPic.css" type="text/css" />
            <script type="text/javascript" src="/style/js/shop_goodPic_base.js"></script>
            <script type="text/javascript" src="/style/js/lib.js"></script>
            <script type="text/javascript" src="/style/js/163css.js"></script>
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="/style/images/img04.jpg" jqimg="/style/images/img04.jpg" width="350">
                </div>
                <div id="spec-n5">
                    <div class=control id="spec-left">
                        <img src="/style/images/left.gif" />
                    </div>
                    <div id="spec-list">
                        <ul class="list-h">
                            <%--<li><img src="/style/images/img01.jpg"> </li>--%>
                            <%--<li><img src="/style/images/img02.jpg"> </li>--%>
                            <%--<li><img src="/style/images/img03.jpg"> </li>--%>
                            <%--<li><img src="/style/images/img04.jpg"> </li>--%>
                            <%--<li><img src="/style/images/img01.jpg"> </li>--%>
                            <%--<li><img src="/style/images/img02.jpg"> </li>--%>
                            <%--<li><img src="/style/images/img03.jpg"> </li>--%>
                            <%--<li><img src="/style/images/img04.jpg"> </li>--%>
                    ...
                    <div class=control id="spec-right">
                        <img src="/style/images/right.gif" />
                    </div>
                ...
                $(function(){
                    ...
                    $.ajax({
                        ...
                        success:function(e){
                            console.log(e)
                            if(e){
                                var images=e.imageurl.split(',');
                                var imgli='';
                                console.log(images)
                                // for(var i=0;i<images.length;i++){
                                //     imgli+=`<li><img src="'+images[i]+'"/></li>`
                                //     console.log(imgli)
                                // }
                                for (var i = 0; i < images.length; i++) {
                                    imgli+='<li><img src="'+images[i]+'"/> </li>';
                                }
                                $('#spec-list>ul').append(imgli);
                                $('#spname').html(e.titlename);
                                $('#spmoney').html(e.money);
                                $('#spmtype').html(e.mtype==0?"卖家承担运费":"买家承担运费");
                                $('#spclick').attr('spid',e.spid);
                            }
                        }
                    ...
                    $("#spclick").click(function(e){
                        ...
                        var spid=$("#spclick").attr('spid')
                        var num=$('#good_nums').val();

                        $.ajax({
                            url:'/gwc/addgwc',
                            type:'post',
                            data:{num:num,spid:spid},
                            success:function(e){
                                console.info(e)
                                if(e&&e.status==1){
        ...
        <div class="shop_goods_show_right">
            <ul>
                <li>
                    <strong style="font-size:14px; font-weight:bold;" id="spname">联想 K900 3G手机（炫酷银）WCDMA/GSM</strong>
                </li>
                <li>
                    <label>价格：</label>
                    <span><strong id="spmoney">200.00</strong>元</span>
                </li>
                <li>
                    <label>运费：</label>
                    <span id="spmtype">卖家承担运费</span>
                </li>
                <li>
                    <label>累计售出：</label>
                    <span>99件</span>
                ...
                <li style="padding:20px 0;">
                    <label>&nbsp;</label>
                    <span><a id="spclick" href="javascript:void(0)" class="goods_sub goods_sub_gou" >加入购物车</a></span>
                </li>
            </ul>
        </div>
    </div>
    <script>
        function addshangpin() {
            var url=$("li:first-child strong").html();
            var money=$("li:nth-child(2) strong").html();
            var number=$(".goods_num input").val();
            console.log(url,money,number)
            var data={}
            data['url']=url
            data['money']=money
            data['number']=number
    ...
    <!-- 商品详情 -->
    <script type="text/javascript" src="/style/js/shop_goods_tab.js"></script>
