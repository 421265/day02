...
<head>
    ...
    <link rel="stylesheet" href="/style/css/shop_form.css" type="text/css" />
        ...
        <div class="shop_meber_bd_good_lists clearfix">
            ...
            <dic class="shop_home_form">
                <form athion="" name="" class="shop_form" method="post">
                    <ul>
                        <li id="uname"><label >用户名称：</label>wanglele</li>
                        <li id="emil"><label >电子邮件：</label>wanglele@hotmail.com</li>
